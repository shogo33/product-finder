...
const ARTICLE_CONFIG = [
  ...
  {
    slug:      'aliexpress-projector-under-10000',
    folder:    'gadget',
    subreddit: 'projectors',
    queries:   ['aliexpress projector review cheap', 'budget projector aliexpress experience', 'HY300 projector review aliexpress'],
    topic:     'アリエクの格安プロジェクターのリアルな評判・使用感・体験談',
  },
  {
    slug:      'naturehike-cot-osusume',
    folder:    'outdoor',
    subreddit: 'Aliexpress',
    queries:   ['camping cot review aliexpress', 'outdoor cot aliexpress purchase experience', 'folding bed camping aliexpress quality'],
    topic:     'アリエクのキャンプコット購入・品質・使用感に関するリアルな体験談',
  },
  {
    slug:      'naturehike-osusume',
    folder:    'outdoor',
    subreddit: 'CampingandHiking',
    queries:   ['Naturehike gear review aliexpress', 'Naturehike tent quality review', 'aliexpress outdoor gear camping experience'],
    topic:     'Naturehikeアウトドアギアのリアルな評判・購入体験談',
  },
  {
    slug:      'aliexpress-1000yen-kawatte-yokatta',
    folder:    'guide',
    subreddit: 'Aliexpress',
    queries:   ['best cheap buy aliexpress under $10', 'aliexpress hidden gems cheap items', 'best value aliexpress purchase under 10 dollars'],
    topic:     'アリエクで買ってよかった格安アイテムのリアルな体験談',
  },
  {
    slug:      'aliexpress-account',
    folder:    'guide',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress account setup problem', 'aliexpress registration trouble', 'aliexpress first order tips beginner'],
    topic:     'AliExpressアカウント登録・初注文に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-choice',
    folder:    'guide',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress choice badge review experience', 'choice vs regular seller aliexpress', 'aliexpress choice quality difference'],
    topic:     'AliExpress Choiceバッジ・Choice商品に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-osusume',
    folder:    'guide',
    subreddit: 'Aliexpress',
    queries:   ['best aliexpress finds recommended', 'aliexpress worth buying recommended items', 'aliexpress must buy items 2024'],
    topic:     'アリエクでおすすめの商品・買ってよかったアイテムのリアルな体験談',
  },
  {
    slug:      'aliexpress-what-is',
    folder:    'guide',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress beginner guide how to buy', 'is aliexpress legit safe first time buyer', 'aliexpress first purchase experience'],
    topic:     'AliExpress初心者の購入体験・安全性に関するリアルな体験談',
  },
  {
    slug:      'naturehike-brand',
    folder:    'guide',
    subreddit: 'Aliexpress',
    queries:   ['Naturehike aliexpress review quality', 'Naturehike gear experience purchase', 'aliexpress outdoor camping brand quality review'],
    topic:     'NaturehikeブランドのAliExpress購入・品質に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-hyoban',
    folder:    'safety',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress seller rating trustworthy review', 'aliexpress feedback score reliable', 'aliexpress seller reputation check'],
    topic:     'AliExpressのセラー評価・信頼性に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-coupon',
    folder:    'payment',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress coupon discount code how to use', 'aliexpress coins voucher deals', 'best aliexpress sale discount tips'],
    topic:     'AliExpressのクーポン・割引コード活用のリアルな体験談',
  },
  {
    slug:      'aliexpress-payment',
    folder:    'payment',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress payment method credit card problem', 'aliexpress payment failed issue', 'aliexpress payment options experience'],
    topic:     'AliExpressの支払い方法・決済に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-paypal',
    folder:    'payment',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress paypal payment experience', 'aliexpress paypal buyer protection', 'aliexpress paypal problem refund'],
    topic:     'AliExpressのPayPal払いに関するリアルな体験談',
  },
  {
    slug:      'aliexpress-paypay',
    folder:    'payment',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress payment method japan', 'aliexpress credit card japan payment', 'aliexpress payment options japan'],
    topic:     'AliExpressの日本向け支払い方法に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-shiharai',
    folder:    'payment',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress payment declined how to fix', 'aliexpress checkout problem payment', 'aliexpress secure payment tips'],
    topic:     'AliExpressの支払い・決済トラブルに関するリアルな体験談',
  },
  {
    slug:      'aliexpress-standard-shipping',
    folder:    'shipping',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress standard shipping delivery time experience', 'aliexpress standard shipping vs other options', 'aliexpress standard shipping Japan arrival'],
    topic:     'AliExpress標準配送の配送日数・体験談',
  },
  {
    slug:      'aliexpress-tracking-number',
    folder:    'shipping',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress tracking number not working', 'aliexpress tracking update not moving', 'how to track aliexpress package'],
    topic:     'AliExpressの追跡番号・荷物追跡に関するリアルな体験談',
  },
  {
    slug:      'aliexpress-tsuiseki',
    folder:    'shipping',
    subreddit: 'Aliexpress',
    queries:   ['aliexpress tracking stuck not updating', 'aliexpress package tracking stopped', 'aliexpress shipping tracking problem solution'],
    topic:     'AliExpressの荷物追跡が止まる・更新されない問題の体験談',
  },
];
