...
const j = await api('aliexpress.affiliate.link.generate', {
  tracking_id: TID,
  source_values: 'https://www.aliexpress.com/item/1005005418055003.html',
  promotion_link_type: '0',
});
console.log(JSON.stringify(j?.aliexpress_affiliate_link_generate_response?.resp_result, null, 2));
